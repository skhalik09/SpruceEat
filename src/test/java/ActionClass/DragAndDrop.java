...
public class DragAndDrop {
    ...
    public void dragAndDrop() throws InterruptedException {
        ...
        WebElement dragBall = driver.findElement(By.xpath("//div[@id='draggable']"));
        Actions actions = new Actions(driver);
        actions.dragAndDrop(dragBall,orangeBox).perform();
        Thread.sleep(2000);
    ...
    public void DragAndDropPractice(){
        ...
        Actions actions = new Actions(driver);
        //actions.clickAndHold(draggable,blueBox).perform();

        blueBox = driver.findElement(By.xpath("//div[@class='test1']"));//reassign
